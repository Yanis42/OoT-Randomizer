...
def global_rules(world):
    ...
    set_rule(world.get_entrance('Lost Woods Bridge'), lambda state: world.open_forest or (state.has('Kokiri Sword')))
    set_rule(world.get_entrance('Deku Tree Basement Path'), lambda state: state.has('Slingshot') or state.has('Bomb Bag'))
    ...
    set_rule(world.get_location('Man on Roof'), lambda state: state.has('Fairy Ocarina'))
    set_rule(world.get_location('Impa House Freestanding PoH'), lambda state: state.is_adult())
    ...
    set_rule(world.get_location('Bottom of the Well Front Left Hidden Wall'), lambda state: state.has('Fairy Ocarina') or state.has('Ocarina of Time'))#
    set_rule(world.get_location('Bottom of the Well Front Center Bombable'), lambda state: state.can_blast())
    set_rule(world.get_location('Bottom of the Well Right Bottom Hidden Wall'), lambda state: state.has('Fairy Ocarina') or state.has('Ocarina of Time'))#
    set_rule(world.get_location('Bottom of the Well Center Large Chest'), lambda state: state.has('Fairy Ocarina') or state.has('Ocarina of Time'))#
    set_rule(world.get_location('Bottom of the Well Center Small Chest'), lambda state: state.has('Fairy Ocarina') or state.has('Ocarina of Time'))#
    set_rule(world.get_location('Bottom of the Well Back Left Bombable'), lambda state: state.can_blast())
    ...
    set_rule(world.get_location('Bottom of the Well Basement Chest'), lambda state: state.can_blast())
    set_rule(world.get_location('Bottom of the Well Locked Pits'), lambda state: state.has('Small Key (Bottom of the Well)', 3)) #These pits are really unfair.  and state.has('Lens of Truth') and state.has('Magic Meter')
    set_rule(world.get_location('Bottom of the Well Behind Right Grate'), lambda state: state.has('Small Key (Bottom of the Well)', 3))
    set_rule(world.get_entrance('Death Mountain Entrance'), lambda state: state.has('Fairy Ocarina') or state.has('Ocarina of Time') or state.is_adult())#
    ...
    set_rule(world.get_location('Dodongos Cavern End of Bridge Chest'), lambda state: state.can_blast() or ((state.has('Bow') or state.has('Hover Boots')) and state.is_adult() and state.has('Hammer')))
    ...
    set_rule(world.get_entrance('Zora River Rocks'), lambda state: state.can_blast())
    set_rule(world.get_location('Zora River Lower Freestanding PoH'), lambda state: state.can_blast() or state.has('Progressive Scale') or (state.has('Hover Boots') and state.is_adult()))
    set_rule(world.get_location('Zora River Upper Freestanding PoH'), lambda state: state.can_blast() or state.has('Progressive Scale') or (state.has('Hover Boots') and state.is_adult()))
    ...
    set_rule(world.get_entrance('Zoras Fountain Fairy'), lambda state: state.can_blast())
    set_rule(world.get_location('Zoras Fountain Fairy Reward'), lambda state: state.has('Zeldas Lullaby'))
    set_rule(world.get_entrance('Jabu Jabus Belly Ceiling Switch'), lambda state: state.has('Slingshot') or state.can_blast() or state.has('Boomerang'))
    ...
    set_rule(world.get_location('Phantom Ganon'), lambda state: state.has('Boss Key (Forest Temple)') or state.has('Progressive Hookshot') and state.is_adult())
    set_rule(world.get_location('Phantom Ganon Heart'), lambda state: state.has('Boss Key (Forest Temple)') or state.has('Progressive Hookshot') and state.is_adult())
    ...
    set_rule(world.get_location('Windmill Freestanding PoH'), lambda state: (state.is_adult() and state.has('Song of Time')) or state.has('Boomerang') or state.has('Progressive Hookshot') and state.is_adult())
    ...
    set_rule(world.get_location('Diving in the Lab'), lambda state: state.has('Progressive Scale', 2) or state.has('Iron Boots') and state.has('Progressive Hookshot'))
    ...
    set_rule(world.get_location('Fire Temple Boss Key Chest'), lambda state: state.is_adult() and state.has('Hammer') or state.has('Bomb Bag') and state.is_adult() and state.has('Progressive Hookshot'))
    ...
    set_rule(world.get_location('Volvagia'), lambda state: state.has('Hammer') and state.is_adult() and state.has('Boss Key (Fire Temple)') and (state.has('Hover Boots') or (state.can_reach('Fire Temple Upper') and (state.has('Song of Time') or state.can_blast()))))
    set_rule(world.get_location('Volvagia Heart'), lambda state: state.has('Hammer') and state.is_adult() and state.has('Boss Key (Fire Temple)') and (state.has('Hover Boots') or (state.can_reach('Fire Temple Upper') and (state.has('Song of Time') or state.can_blast()))))
    set_rule(world.get_location('Sheik in Crater'), lambda state: state.is_adult())
    set_rule(world.get_location('Link the Goron'), lambda state: state.is_adult() and (state.has('Progressive Strength Upgrade') or state.can_blast() or state.has('Bow')))
    ...
    set_rule(world.get_location('Water Temple Cracked Wall Chest'), lambda state: state.can_blast())
    ...
    set_rule(world.get_entrance('Shadow Temple Bomb Wall'), lambda state: state.can_blast() and state.has('Small Key (Shadow Temple)', 1))
    ...
    set_rule(world.get_entrance('Haunted Wasteland Crossing'), lambda state: state.has('Fairy Ocarina') or state.has('Ocarina of Time'))#
    set_rule(world.get_entrance('Colossus Warp Pad'), lambda state: state.has('Requiem of Spirit'))
    set_rule(world.get_entrance('Colossus Fairy'), lambda state: state.can_blast())
    ...
    set_rule(world.get_entrance('Gerudo Training Ground Beamos'), lambda state: state.can_blast())
    ...
    set_rule(world.get_location('Gerudo Training Grounds Beamos Chest'), lambda state: state.can_blast())
    ...
    set_rule(world.get_location('Gerudo Training Grounds Maze Path First Chest'), lambda state: state.has('Small Key (Gerudo Training Grounds)', 4) or state.has('Bomb Bag') and state.is_adult() and state.has('Progressive Hookshot'))
    set_rule(world.get_location('Gerudo Training Grounds Maze Path Second Chest'), lambda state: state.has('Small Key (Gerudo Training Grounds)', 6) or state.has('Bomb Bag') and state.is_adult() and state.has('Progressive Hookshot'))
    set_rule(world.get_location('Gerudo Training Grounds Maze Path Third Chest'), lambda state: state.has('Small Key (Gerudo Training Grounds)', 7) or state.has('Bomb Bag') and state.is_adult() and state.has('Progressive Hookshot'))
    ...
    set_rule(world.get_location('Gerudo Training Grounds Maze Path Final Chest'), lambda state: state.has('Bomb Bag') and state.is_adult() and state.has('Progressive Hookshot') or (state.has('Small Key (Gerudo Training Grounds)', 9)) or (item_name(state, 'Gerudo Training Grounds Maze Path Final Chest') == 'Small Key (Gerudo Training Grounds)' and state.has('Small Key (Gerudo Training Grounds)', 8))) #Allow key for key
    ...
    set_rule(world.get_location('Spirit Temple Child Climb East Chest'), lambda state: state.can_blast() or ((state.has('Boomerang') or state.has('Slingshot')) and (state.has('Progressive Hookshot') or state.has('Bow'))) or (state.has('Small Key (Spirit Temple)', 3) and state.has('Progressive Strength Upgrade', 2) and state.is_adult() and (state.has('Progressive Hookshot') or state.has('Bow'))) or (state.has('Small Key (Spirit Temple)', 5) and state.has('Requiem of Spirit') and (state.has('Boomerang') or state.has('Slingshot'))))
    set_rule(world.get_location('Spirit Temple Child Climb North Chest'), lambda state: state.can_blast() or ((state.has('Boomerang') or state.has('Slingshot')) and (state.has('Progressive Hookshot') or state.has('Bow'))) or (state.has('Small Key (Spirit Temple)', 3) and state.has('Progressive Strength Upgrade', 2) and state.is_adult() and (state.has('Progressive Hookshot') or state.has('Bow'))) or (state.has('Small Key (Spirit Temple)', 5) and state.has('Requiem of Spirit') and (state.has('Boomerang') or state.has('Slingshot'))))
    set_rule(world.get_location('Spirit Temple Sun Block Room Chest'), lambda state: (state.has('Small Key (Spirit Temple)', 5) and state.can_blast() and state.has('Requiem of Spirit')) or (state.has_fire_source() and (state.can_blast() or state.has('Small Key (Spirit Temple)', 2))))
    ...
    set_rule(world.get_location('Spirit Temple Hallway Left Invisible Chest'), lambda state: state.has('Fairy Ocarina') or state.has('Ocarina of Time'))#
    set_rule(world.get_location('Spirit Temple Hallway Right Invisible Chest'), lambda state: state.has('Fairy Ocarina') or state.has('Ocarina of Time'))#
    ...
    set_rule(world.get_location('Twinrova'), lambda state: state.has('Mirror Shield') and state.can_blast() and state.has('Progressive Hookshot') and state.has('Boss Key (Spirit Temple)'))
    set_rule(world.get_location('Twinrova Heart'), lambda state: state.has('Mirror Shield') and state.can_blast() and state.has('Progressive Hookshot') and state.has('Boss Key (Spirit Temple)'))
    ...
    set_rule(world.get_location('Ganons Castle Shadow Trial Clear'), lambda state: state.has('Magic Meter') and state.has('Bow') and state.has('Light Arrows') and state.has('Hammer') and (state.has('Fire Arrows') or state.has('Progressive Hookshot', 2)) and ((state.has('Hover Boots') and state.has('Progressive Hookshot', 2))))
    ...
    set_rule(world.get_location('Ganons Castle Spirit Trial Clear'), lambda state: state.has('Magic Meter') and state.has('Bow') and state.has('Light Arrows') and state.has('Mirror Shield') and state.can_blast() and state.has('Progressive Hookshot'))
    set_rule(world.get_location('Ganons Castle Spirit Trial First Chest'), lambda state: state.has('Bomb Bag') and state.is_adult() and state.has('Progressive Hookshot') or state.has('Progressive Hookshot') and (state.has('Magic Meter') or state.can_blast()))
    set_rule(world.get_location('Ganons Castle Spirit Trial Second Chest'), lambda state: state.has('Bomb Bag') and state.is_adult() and state.has('Progressive Hookshot') or state.has('Progressive Hookshot') and state.has('Magic Meter') and state.can_blast())
    ...
    set_rule(world.get_location('Ganons Castle Light Trail Invisible Enemies Chest'), lambda state: state.has('Fairy Ocarina') or state.has('Ocarina of Time'))#
    ...
    set_rule(world.get_entrance('Lost Woods Sales Grotto'), lambda state: state.can_blast() or (state.has('Hammer') and state.is_adult() and (state.has('Minuet of Forest') or state.has('Sarias Song'))))
    set_rule(world.get_entrance('Front of Meadow Grotto'), lambda state: state.can_blast() or (state.has('Hammer') and state.is_adult() and (state.has('Minuet of Forest') or state.has('Sarias Song'))))
    ...
    set_rule(world.get_location('GS9'), lambda state: state.has('Slingshot') or state.can_blast() or state.has('Boomerang') or (state.has('Dins Fire') and state.has('Magic Meter')))
...
# Jabu Jabu GS need no reqs becuase the access reqs for their zones cover them.
    ...
    set_rule(world.get_location('GS78'), lambda state: state.has('Small Key (Bottom of the Well)', 3) and state.has('Boomerang') and (state.has('Progressive Strength Upgrade') or state.has('Bomb Bag')))
