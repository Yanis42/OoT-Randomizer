...
def guiMain(args=None):
    ...
    createSpoilerCheckbutton = Checkbutton(checkBoxFrame, text="Create Spoiler Log", onvalue=0, offvalue=1, variable=createSpoilerVar)
    suppressRomVar = IntVar()
    suppressRomCheckbutton = Checkbutton(checkBoxFrame, text="Do not create patched Rom", variable=suppressRomVar)
    compressRomVar = IntVar()
    compressRomCheckbutton = Checkbutton(checkBoxFrame, text="Compress patched Rom", onvalue=0, offvalue=1, variable=compressRomVar)
    openForestVar = IntVar()
    openForestCheckbutton = Checkbutton(checkBoxFrame, text="Open Forest", onvalue=0, offvalue=1, variable=openForestVar)
    openDoorVar = IntVar()
    openDoorCheckbutton = Checkbutton(checkBoxFrame, text="Open Door of Time", onvalue=0, offvalue=1, variable=openDoorVar)
    ...
    hintsVar = IntVar()
    hintsCheckbutton = Checkbutton(checkBoxFrame, text="Gossip Stone Hints with Stone of Agony", onvalue=0, offvalue=1, variable=hintsVar)
